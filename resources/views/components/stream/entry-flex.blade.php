...
?>
<div class="mt-3 border rounded-sm md:rounded-md shadow-lg bg-white flex-col-reverse lg:flex-row flex items-stretch text-xs sm:text-base">
    ...
    @if ($entry->image)
        <div class="flex-auto w-full md:w-full xl:w-1/2">
            <?php
            $width = rand(3, 4) * 100;
            $height = rand(3, 4) * 100;
            ?>
